    ...
    <div class="container" >
      <div class="hero_section">          
            <div class="top_left_cont zoomIn wow animated"> 
              <h4>Homeowner Association & Property Management </h4><br> 
              <h2><strong>Community Success Begins  <br>  with San Antonio Valley 2</strong></h2>
              <div class="underline"></div>
              <br><br><br><br><br>            
              <a href="about us.php" class="read_more2">Read More ></a> 
            </div>        
      </div>
    </div>
</div>
