	...
	<div class="box">
		<form action="/action_page.php" method="post">
  			<div class="container_l wow bounceInDown">
  	            ...
  	            <button type="submit" class="button_l">LOGIN</button><br><br><br>
  	            <span class="psw">Don't have an account yet? <a href="signup.php"><u>Sign Up</u></a></span><br>
                <span class="psw">Are you an employee? <a href="login_employee.php"><u>Click here</u></a></span><br>
                <span class="psw">Are you an admin? <a href="login_admin.php"><u>Click here</u></a></span>
 			</div>
		</form>	
	</div>
